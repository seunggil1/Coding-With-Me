  ...
  <q-layout view="hHh lpR fFf">
    ...
    <q-page-container>
      <div class="column main-container">
        ...
        <div :class="((video.subCamsOpen && video.state.session) ? 'col-10 row' : 'col-12 row') + 'full-width '">
          <div>
            ...
            >
              ...
              <template v-slot:after>
                <div class="q-pa-md full-height">
                  ...
                  <web-editor ref="myIde" :code="video.state.myCode" language="java" :readOnly="false"></web-editor>
                  </div>
              </template>
            </q-splitter>
            ...
            >
              <template v-slot:before>
                <div class="q-pa-md full-height full-width">
                  ...
                  <web-editor ref="teacherIde" :code="video.state.teacherCode" language="java" :readOnly="true"></web-editor>
                </div>
              </template>
              <template v-slot:after>
                <div class="q-pa-md full-height full-width">
...
export default{
  ...
  setup(props) {
    ...
    watch(teacherIde, () => {
      if(teacherIde.value)
			  console.log(teacherIde.value.updateEditor);
		});
