	...
	<q-layout view="hHh lpR fFf">
		...
		>
			<div class="column drawer-container">
				...
				<div
					class="col-10 column justify-center items-center"
					style="border: 1px solid blue"
				>
		...
		<q-page-container>
			<div v-if="video.subCamsOpen" class="column main-container">
				...
				<div class="col-10 row">
					<div>
						<q-splitter v-model="splitterModel" style="height: 78.9vh">
			...
			<div v-else class="column main-container">
				<div class="col-12 row">
					<div>
						<q-splitter v-model="splitterModel" style="height: 94.71vh">
							<template v-slot:before>
								<div class="q-pa-md">
									<div class="text-h4 q-mb-md">Pdf 뷰어 부분</div>
									<div v-for="n in 20" :key="n" class="q-my-md">
